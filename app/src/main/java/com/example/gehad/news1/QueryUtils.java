    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i=0; i < jsonResultsArray.length(); i++){
                ...
                String articleContentSummary = jsonFieldsObject.getString("trailText");
                String articleAuthor = jsonFieldsObject.getString("byline");
                String articlePhoto = jsonFieldsObject.getString("thumbnail");
